...
const jumbotron = {
    title: 'Sleevr',
    subtitle: 'A Colored Cable Sleeving Design Tool',
};

const pitchBlock = {
    questionHeader: 'Have you ever:',
    questionOne: 'Created custom sleeves for your PC or electronic cables?',
...
const startPageConstants = { jumbotron, pitchBlock };

export default startPageConstants;
